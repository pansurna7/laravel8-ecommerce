...
insert  into `products`(`id`,`sku`,`name`,`slug`,`price`,`weight`,`width`,`height`,`length`,`category_id`,`admin_id`,`text_description`,`description`,`status`,`images`,`created_at`,`updated_at`) values 
(6,'AB0004','PC Buildup','pc-buildup',6000000.00,0.20,100.00,100.00,100.00,5,2,'des','',1,NULL,'2021-06-02 12:18:10','2021-06-02 12:18:10'),
(7,'AB0005','Notebook Vivo','notebook-vivo',10000000.00,0.30,2.00,3.00,1.00,4,2,'mmmmmmmmmmmmm','dessssssssssssss',1,NULL,'2021-06-02 14:44:57','2021-06-02 20:48:56');
